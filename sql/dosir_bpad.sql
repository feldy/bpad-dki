...
--
-- Host: localhost
-- Generation Time: Feb 14, 2017 at 05:55 AM
...
INSERT INTO `tbl_user` (`sid`, `username`, `password`, `role`, `nama`) VALUES
('c3cbfe10-f23a-11e6-be89-1c4bd6ab0296', 'root', 'admin', 'admin', 'Nanang Suryana');
...
ALTER TABLE `tbl_artikel`
  ADD PRIMARY KEY (`sid`);
ALTER TABLE `tbl_artikel` ADD FULLTEXT KEY `isi` (`judul`,`category`,`isi`);
ALTER TABLE `tbl_artikel` ADD FULLTEXT KEY `isi_2` (`isi`);
